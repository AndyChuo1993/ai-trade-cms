...
export const seoIndustries: SeoIndustry[] = [
  {
    ...
    description: {
      cn: '协助机械与自动化设备企业开发海外买家，从决策人资料到开发信、到询盘转化，建立稳定出口订单来源。',
    zh: '協助機械與自動化設備企業開發海外買家，從決策人資料到開發信、到詢價轉化，建立穩定出口訂單來源。',
    ...
    strategy: {
      cn: [
        '海外采购与决策人资料以「產線类别型＋產能规模＋既有设备品牌」來筛选，避免无效開發。',
        '開發信聚焦「解決某個痛点」與「可提供的验证数据」（案例、規格、测试方式）。',
        '設定 4–6 次節奏式跟进，並在第 2–3 封加入「应用场景與導入條件」以提高回复率。',
      ],
    zh: [
        '海外採購與決策人資料以「產線類別型＋產能規模＋既有設備品牌」來篩選，避免無效開發。',
  ...
  },
  {
    ...
    ctaDesc: { cn: '我們可協助你定义买家畫像、建立资料並启动開發節奏。',
    zh: '我們可協助你定義買家畫像、建立資料並啟動開發節奏。', en: 'We help define ICP, build lists, and run outreach sequences.' },
    faq: [
      { q: { cn: '要先有英文型錄嗎？',
  ...
  },
  {
    ...
    strategy: { cn: ['资料以產品应用分类（套件裝/工业/医疗等），訊息聚焦应用痛点。', '強調品管體系與一致性：材料追溯、檢驗流程、良率。', '提供快速打樣流程與可预期的導入節奏。'],
    zh: ['資料以產品應用分類別（套件裝/工業/醫療等），訊息聚焦應用痛點。', '強調品管體系與一致性：材料追溯、檢驗流程、良率。', '提供快速打樣流程與可預期的導入節奏。'], en: ['Segment by application and tailor messaging to pain points.', 'Emphasize QC and consistency: traceability, inspection, yield.', 'Offer fast sampling workflows and predictable onboarding.'] },
  ...
  },
  {
    ...
    ctaDesc: { cn: '我们可以协助你建立决策人资料库并用合规导向的说法提高回复率。',
    zh: '我們可協助你建立決策人資料庫並用合規導向的說法提高回覆率。', en: 'We help build lists and improve reply rates with compliance-led messaging.' },
    faq: [
      { q: { cn: '需要先準備哪些文件？',
  ...
  },
  {
    ...
    strategy: { cn: ['用產品族群與应用场景切资料（如底盤、電系、內裝）。', '在開發信中提供质量體系與檢驗能力摘要。', '以项目式跟进節奏推進：需求确认→样品→测试→試單。'],
    zh: ['用產品族群與應用場景切資料（如底盤、電系、內裝）。', '在開發信中提供品質體系與檢驗能力摘要。', '以專案式跟進節奏推進：需求確認→樣品→測試→試單。'], en: ['Segment lists by product family and application.', 'Include QC system and inspection capability summary.', 'Use project-style follow-ups: requirement → sample → test → trial order.'] },
