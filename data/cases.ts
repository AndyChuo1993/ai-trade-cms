...
const zh: Record<string, CaseContent> = {
  hardware: {
    ...
    summary: '協助企業建立海外採購與決策人資料並進行客戶開發，成功建立多個潛在客戶聯繫與合作機會。',
    result: '詢問成長與市場拓展',
    highlights: [
    ...
    after: ['建立精準採購與決策人資料', '自動化開發信', '穩定詢問來源'],
    sections: [
      ...
      { heading: '我們的策略', paragraphs: ['我們為其量身建立外銷外包服務方案，從零建立歐洲開發體系：'], items: ['鎖定德國、荷蘭中大型五金進口商與批發商', '建立採購經理的精準資料', '設計強調製造品質與代工彈性的英文開發信'] },
      { heading: '執行方式', items: ['首月：建立 500 家以上目標客戶資料，進行首輪測試', '次月：最佳化開發信主旨與內容，提升開啟率至 40% 以上', '第三個月：全面自動化跟進，並由團隊協助初步詢問篩選'] },
  ...
  packaging: {
    ...
    after: ['日文在地化', '精準資料', '高互動率'],
    sections: [
      { heading: '背景', paragraphs: ['客戶為軟套件裝材料供應商，希望拓展日本與東南亞市場。日本市場以封閉與重視信任著稱，過去使用英文開發效果不佳。'] },
      { heading: '市場困境', items: ['語言障礙導致溝通不順', '日本客戶對陌生海外供應商信任度低', '缺乏精準的終端品牌客戶資料（食品、化妝品廠）'] },
      { heading: '我們的策略', paragraphs: ['實施深度在地化的開發策略：'], items: ['建立日本食品、美妝與日用品工廠的精準資料', '由日文顧問協助潤飾開發信，確保商務禮儀與語氣自然', '強調品質檢驗標準與既有日系客戶實績，以建立信任'] },
      { heading: '執行方式', items: ['分產業建立資料，優先鎖定中型品牌商', '使用日文進行所有書面溝通', '提供免費樣品寄送服務作為破冰誘因'] },
  ...
  machinery: {
    ...
    proofImages: [proofImages.chart],
    summary: '透過精準資料與電話開發，成功安排 15 場經銷商會議，簽約 3 家代理。',
    result: '通路佈局、代理簽約',
    highlights: [
      { num: '15', label: '商務會議' },
      { num: '3', label: '代理簽約' },
    ...
    sections: [
      ...
      { heading: '市場困境', items: ['缺乏當地通路資料，難以辨識有實力的經銷商', '語言隔閡，僅靠英文開發信回覆率低', '需要深入溝通才能確認對方的技術服務能力'] },
      { heading: '我們的策略', paragraphs: ['結合資料開發與會議邀約：'], items: ['建立越南與泰國前 50 大套件裝機械進口商資料', '透過當地語言（越文與泰文）進行陌生開發電話', '目標是直接安排視訊會議，而非僅止於索取報價'] },
...
const cn: Record<string, CaseContent> = {
  hardware: {
    ...
    cover: baseCovers.hardware,
    proofImages: [proofImages.chart],
    summary: '协助企业建立海外采购与决策人资料并进行客户开发，成功建立多个潜在客户联系与合作机会。',
    result: '询盘增长与市场拓展',
    highlights: [
    ...
    after: ['建立精准采购与决策人资料', '自动化开发信', '稳定询盘来源'],
    sections: [
      ...
      { heading: '我们的策略', paragraphs: ['我们为其量身建立外贸外包服务方案，从零建立欧洲开发体系：'], items: ['锁定德国、荷兰中大型五金进口商与批发商', '建立采购经理的精准资料', '设计强调制造质量与代工弹性的英文开发信'] },
      { heading: '执行方式', items: ['首月：建立 500 家以上目标客户资料，进行首轮测试', '次月：优化开发信主题与内容，提升开启率至 40% 以上', '第三个月：全面自动化跟进，并由团队协助初步询盘筛选'] },
  ...
  packaging: {
    ...
    after: ['日文本地化', '精准资料', '高互动率'],
    sections: [
      { heading: '背景', paragraphs: ['客户为软包装材料供应商，希望拓展日本与东南亚市场。日本市场以封闭与重视信任著称，过去使用英文开发效果不佳。'] },
      { heading: '市场困境', items: ['语言障碍导致沟通不顺', '日本客户对陌生海外供应商信任度低', '缺乏精准的终端品牌客户资料（食品、化妆品厂）'] },
      { heading: '我们的策略', paragraphs: ['实施深度本地化的开发策略：'], items: ['建立日本食品、美妆与日用品工厂的精准资料', '由日文顾问协助润饰开发信，确保商务礼仪与语气自然', '强调质量检验标准与既有日系客户实绩，以建立信任'] },
      { heading: '执行方式', items: ['分行业建立资料，优先锁定中型品牌商', '使用日文进行所有书面沟通', '提供免费样品寄送服务作为破冰诱因'] },
  ...
  machinery: {
    ...
    cover: baseCovers.machinery,
    proofImages: [proofImages.chart],
    summary: '通过精准资料与电话开发，成功安排 15 场经销商会议，签约 3 家代理。',
    result: '渠道布局、代理签约',
    highlights: [
      { num: '15', label: '商务会议' },
      { num: '3', label: '代理签约' },
    ...
    sections: [
      ...
      { heading: '市场困境', items: ['缺乏当地渠道资料，难以辨识有实力的经销商', '语言隔阂，仅靠英文开发信回复率低', '需要深入沟通才能确认对方的技术服务能力'] },
      { heading: '我们的策略', paragraphs: ['结合资料开发与会议邀约：'], items: ['建立越南与泰国前 50 大包装机械进口商资料', '通过当地语言（越文与泰文）进行陌生开发电话', '目标是直接安排视频会议，而非仅止于索取报价'] },
