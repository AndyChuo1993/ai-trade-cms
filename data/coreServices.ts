...
export const coreServices = {
  ...
  zh: [
    ...
    zh: '取得100個潛在海外客戶開發起點', en: 'Get 100 Potential Buyer Data Profiles' }, href: '/buyers-list' },
      secondary: { label: { cn: '预约策略通话',
    zh: '預約策略通話', en: 'Book Strategy Call' }, href: '/contact' },
  ...
  exportSalesOutsourcing: {
    ...
    ctaTitle: { cn: '预約策略通话',
    zh: '預約策略通話', en: 'Want repeatable export sales growth?' },
